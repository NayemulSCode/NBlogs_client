        ...
        <div className="flex flex-no-wrap">
            ...
            <div className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between flex">
                <div className="px-8">
                    ...
                    <ul className="mt-12">
                    <Link to="/" className="flex w-full justify-between text-gray-400 hover:text-gray-500 cursor-pointer items-center mb-6">
                        ...
                        <Link to="" className="flex w-full justify-between text-gray-100 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                            ...
                            <div className="py-1 px-3 bg-gray-700 rounded text-gray-400 flex items-center justify-center text-xs">5</div>
                        </Link>
                        <Link to="/addBlog"  className="flex w-full justify-between text-gray-400 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                        ...
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Blog Content</span>
                            </div>
                        ...
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Blog Management</span>
                            </div>
                        </li>
                        <Link to="/"  className="flex w-full justify-between text-gray-400 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span onClick={()=> handleSignOut()} className="text-sm  ml-2">Sign Out</span>
                            </div>
                        </Link>
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-500 cursor-pointer items-center">
                            <div className="flex items-center">
